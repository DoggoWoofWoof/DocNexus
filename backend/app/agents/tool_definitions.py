        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "physician_list": {
                        "type": "array",
                        "description": "Filtered physician records returned by get_physician_data. Usually omit this; the backend injects the canonical filtered list.",
                        "items": {"type": "object"},
                    },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                ...
                "required": ["analysis_type", "dimensions"],
                "additionalProperties": False,
            },
        },
    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "dataset": {
                        "type": "array",
                        "description": "Filtered physician records for code execution. Usually omit this; the backend injects the canonical filtered list.",
                        "items": {"type": "object"},
                    },
                    "chart_type": {
                        "type": "string",
                        "description": "Optional chart type such as bar, line, scatter, or histogram. Use bar for state rankings, concentration, distribution, and 'show me which states' requests.",
                    },
                },
                "required": ["code_goal"],
                "additionalProperties": False,
